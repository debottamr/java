package com.app.inhertancediscriminator;
	...
	public static SessionFactory buildSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				MetadataSources sources = new MetadataSources(registry).addAnnotatedClass(Vehicle.class).addAnnotatedClass(TwoWheeler.class).addAnnotatedClass(FourWheeler.class);
