package com.app.onetomany.entity.cascadesaveupdate;
	...
	public static SessionFactory buildSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				MetadataSources sources = new MetadataSources(registry).addAnnotatedClass(Stock.class).addAnnotatedClass(StockDailyRecord.class);
