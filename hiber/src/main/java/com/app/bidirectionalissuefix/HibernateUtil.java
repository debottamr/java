package com.app.bidirectionalissuefix;
	...
	public static SessionFactory buildSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				MetadataSources sources = new MetadataSources(registry).addAnnotatedClass(AccountEntity.class).addAnnotatedClass(EmployeeEntity.class);
