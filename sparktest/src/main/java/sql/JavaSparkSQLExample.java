...
// $example off:create_ds$
	...
	private static void runBasicDataFrameExample(SparkSession spark) throws AnalysisException {
		// $example on:create_df$
		Dataset<Row> df = spark.read().json("/home/debottamr/javaworkspace/sparktest/src/main/resources/sql/people.json");
	...
	private static void runDatasetCreationExample(SparkSession spark) {
		...
		// on name
		String path = "/home/debottamr/javaworkspace/sparktest/src/main/resources/sql/people.json";
	...
	private static void runInferSchemaExample(SparkSession spark) {
		...
		JavaRDD<Person> peopleRDD = spark.read().textFile("/home/debottamr/javaworkspace/sparktest/src/main/resources/sql/people.txt").javaRDD()
				.map(line -> {
	...
	private static void runProgrammaticSchemaExample(SparkSession spark) {
		// $example on:programmatic_schema$
		// Create an RDD
		JavaRDD<String> peopleRDD = spark.sparkContext().textFile("/home/debottamr/javaworkspace/sparktest/src/main/resources/sql/people.txt", 1)
				.toJavaRDD();
