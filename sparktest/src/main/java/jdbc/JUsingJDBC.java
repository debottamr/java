...
public final class JUsingJDBC {
	...
	public static void main(String[] args) throws Exception {
		SparkSession spark = SparkSession.builder().appName("JUsingJDBC").master("local").getOrCreate();

		// Load properties from file
		Properties dbProperties = new Properties();
		dbProperties.load(new FileInputStream(new File("/home/debottamr/javaworkspace/sparktest/src/main/resources/jdbc/db-properties.flat")));
