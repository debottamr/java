...
public class DataFrameExample {
	...
	public static void main(String[] args) {
		...
		JavaRDD<String> rdd = jsp.textFile("file:///home/debottamr/javaworkspace/spark16/src/main/resources/employee");
		...
		maxSalDataFrame.toJavaRDD().foreach(new VoidFunction<Row>() {
			...
			public void call(Row arg0) throws Exception {
				System.out.println(
						" Name is :" + arg0.get(0) + " Emp id is:" + arg0.get(1) + " Salary is:" + arg0.get(2));
			}
		});
	}
}